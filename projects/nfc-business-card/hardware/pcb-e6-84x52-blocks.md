...
2026-09-21：继续使用独立 [NFC-Business-Card-84x52-E6-Blocks.eprj2](../../../eda/NFC-Business-Card-84x52-E6-Blocks.eprj2)，保留 [E6 原版](../../../eda/NFC-Business-Card-84x52-E6.eprj2)作比较。含壳 84 × 52 mm、优先薄度、至少两键、屏幕与电池平铺的约束不变。当前仍是**试布线草案，不能下单**。
