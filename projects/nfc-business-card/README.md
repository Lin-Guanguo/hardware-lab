...
- **当前板面：60 段铜线、19 个 0.3/0.2 mm 过孔**；USB 侧 CC1、CC2、DP_CONN、DM_CONN、DP_MCU、DM_MCU、VBUS **七个网络全部连通**，连接错误从 200 降到 **176**，普通间距错误只剩 **1 项既有 BAT_PACK 测试点冲突**，整个 USB 布线没有引入任何新错误。E7/E11 时代"两层做不出 USB 数据扇出"的结论已被推翻。
