...
render(BASE/'nfc-card-e16-bottom-v2.stl', (120, 150, 185), d, 6.2, 400, 300)
render(BASE/'nfc-card-e16-top-v2.stl', (150, 178, 210), d, 6.2, 1010, 300)
d.text((40, 30), 'E16 enclosure V2 - bottom (left) and top (right), shaded isometric from STL', fill=(30, 45, 65))
d.text((40, 55), 'outer = PCB outline 84 x 52, 1.0 mm inboard ledge, PCB edge exposed', fill=(80, 95, 115))
d.text((40, 78), 'top: 27.8 mm screen window over the 27x27 active area + three key holes; bezel boss covers the panel border', fill=(80, 95, 115))
img.save(OUT/'e16-enclosure-v2-iso.png')
print('saved', OUT/'e16-enclosure-v2-iso.png')
