"""Generate the E16 enclosure sample V3 for the right-mid USB layout.
...
MODEL = OUT / "nfc-card-e16-enclosure-v3.FCStd"
STEP = OUT / "nfc-card-e16-enclosure-v3.step"
BOTTOM_STL = OUT / "nfc-card-e16-bottom-v3.stl"
TOP_STL = OUT / "nfc-card-e16-top-v3.stl"
REPORT = OUT / "nfc-card-e16-enclosure-v3-report.json"
...
doc = App.newDocument("NfcCardE16EnclosureV3")
doc.Label = "NFC 名片 · E16 右侧中部 USB 外壳协调样件 V3"
doc.Comment = "外壳外缘 = PCB 板框（叠层式）；连接器前缘按原厂图纸修正到 x=85.3。"

params = doc.addObject("App::FeaturePython", "EnclosureParameters")
params.Label = "E16 外壳 V3 参数与证据"
...
params.Status = "E16_ENCLOSURE_V3_SAMPLE_NOT_PRODUCTION_RELEASE"
...
report = {
    "status": "E16_ENCLOSURE_V3_SAMPLE_NOT_PRODUCTION_RELEASE",
