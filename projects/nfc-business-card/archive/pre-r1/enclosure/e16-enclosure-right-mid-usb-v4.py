"""Generate the E16 enclosure sample V4 for the right-mid USB layout.

V4 fixes a defect found by probing the saved V3 solid: V3 built both printed
...
MODEL = OUT / "nfc-card-e16-enclosure-v4.FCStd"
STEP = OUT / "nfc-card-e16-enclosure-v4.step"
BOTTOM_STL = OUT / "nfc-card-e16-bottom-v4.stl"
TOP_STL = OUT / "nfc-card-e16-top-v4.stl"
REPORT = OUT / "nfc-card-e16-enclosure-v4-report.json"
...
doc = App.newDocument("NfcCardE16EnclosureV4")
doc.Label = "NFC 名片 · E16 右侧中部 USB 外壳协调样件 V4"
doc.Comment = "外壳外缘 = PCB 板框（叠层式）；连接器前缘按原厂图纸修正到 x=85.3。"

params = doc.addObject("App::FeaturePython", "EnclosureParameters")
params.Label = "E16 外壳 V4 参数与证据"
...
params.Status = "E16_ENCLOSURE_V4_SAMPLE_NOT_PRODUCTION_RELEASE"
...
report = {
    "status": "E16_ENCLOSURE_V4_SAMPLE_NOT_PRODUCTION_RELEASE",
