...
更新：2026-09-20。范围：功能框图、供电边界与原理图输入；已形成 [EDA 原理图草案](../archive/pre-r1/hardware/schematic-draft.md)，尚未完成制造设计或验证实物。对应 [候选 BOM](candidate-bom.md) 和[六色屏/302030 空间研究](../archive/pre-r1/enclosure/pcba-e6-302030.svg)。框图反映当前选样方向，EDA 的屏幕电路尚未迁移。
