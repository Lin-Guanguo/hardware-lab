"""Generate the E16 enclosure sample V6 for the right-mid USB layout.

V6 fixes a defect found by probing the saved V3 solid: V3 built both printed
...
MODEL = OUT / "nfc-card-e16-enclosure-v6.FCStd"
STEP = OUT / "nfc-card-e16-enclosure-v6.step"
BOTTOM_STL = OUT / "nfc-card-e16-bottom-v6.stl"
TOP_STL = OUT / "nfc-card-e16-top-v6.stl"
CAPS_STL = OUT / "nfc-card-e16-keycaps-v6.stl"
REPORT = OUT / "nfc-card-e16-enclosure-v6-report.json"
...
KEYS = ((38.1, 3.20), (38.1, 9.50), (46.3, 6.35))
...
doc = App.newDocument("NfcCardE16EnclosureV6")
doc.Label = "NFC 名片 · E16 右侧中部 USB 外壳协调样件 V6"
doc.Comment = "外壳外缘 = PCB 板框（叠层式）；连接器前缘按原厂图纸修正到 x=85.3。"

params = doc.addObject("App::FeaturePython", "EnclosureParameters")
params.Label = "E16 外壳 V6 参数与证据"
...
params.Status = "E16_ENCLOSURE_V6_SAMPLE_NOT_PRODUCTION_RELEASE"
...
report = {
    "status": "E16_ENCLOSURE_V6_SAMPLE_NOT_PRODUCTION_RELEASE",
