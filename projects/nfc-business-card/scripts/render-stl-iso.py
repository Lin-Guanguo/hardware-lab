...
render(BASE/'nfc-card-e16-bottom-v1.stl', (120, 150, 185), d, 6.2, 400, 520)
render(BASE/'nfc-card-e16-top-v1.stl', (150, 178, 210), d, 6.2, 1010, 520)
d.text((40, 30), 'E16 enclosure V1 - bottom (left) and top (right), shaded isometric from STL', fill=(30, 45, 65))
d.text((40, 55), 'top shell: screen window (slot), three 4 mm key holes (right), USB wall slot on the far edge', fill=(80, 95, 115))
d.text((40, 78), 'bottom shell: cavity + USB wall slot; both shells single solids, no shell-shell intersection', fill=(80, 95, 115))
img.save(OUT/'e16-enclosure-iso.png')
print('saved', OUT/'e16-enclosure-iso.png')
